...
const PORTFOLIO = [
  ...
  },
  {
    id: 'saas-security',
    category: 'web',
    title: 'SecureHR — SaaS Platform',
    client: 'SecureHR Solutions, Pune',
    tag: 'Web Engineering',
    image: 'assets/port_4.jpg',
    color: 'cyan',
    problem: 'SecureHR needed an HR SaaS with multi-tenancy for 200+ enterprise clients, GDPR/PDPA compliance, and role-based access control. Previous vendor\'s build had 3 critical OWASP vulnerabilities.',
    solution: 'Architected from scratch with Django + PostgreSQL row-level security. Implemented JWT + OAuth2.0 with RBAC, rate-limiting on all API endpoints, automated VAPT scans in CI/CD, and SOC2 audit trail logging.',
    architecture: ['Django multi-tenant architecture', 'Row-Level Security (PostgreSQL)', 'JWT + OAuth2 + RBAC', 'OWASP-compliant API layer', 'Automated VAPT in CI/CD'],
    metrics: [
      { num: '0', label: 'Security vulnerabilities' },
      { num: '200+', label: 'Enterprise clients onboarded' },
      { num: 'SOC2', label: 'Type II compliant' },
      { num: '₹80L', label: 'ARR achieved post-launch' },
    ]
  },
  {
    id: 'product-photos',
